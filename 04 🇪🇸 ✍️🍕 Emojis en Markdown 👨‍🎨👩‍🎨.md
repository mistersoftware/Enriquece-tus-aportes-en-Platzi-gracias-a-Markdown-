...
Para incluir un emoji **siempre podrás copiar y pegar** el emoji mismo de la tabla. Si no encuentras el que buscas revisa el  [listado completo de emojis aquí](https://platzi.com/comunidad/emojis-y-mas-emojis-en-markdown/).
